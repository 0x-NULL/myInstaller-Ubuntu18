...
# Here comes the rest~
sh auto/apt2.sh
sh auto/asleap.sh # for airgeddon
#sh auto/attack-navigator.sh
sh auto/bettercap.sh
sh auto/brakeman.sh
sh auto/bully.sh
sh auto/caldera.sh
sh auto/cypress.sh
sh auto/dnsenum.sh
sh auto/mdk4.sh # for airgeddon
sh auto/airgeddon.sh # should have bettercap
sh auto/CrackMapExec.sh
...
sh auto/fern-wifi-cracker.sh
sh auto/findmyhash.sh
...
sudo chown -R johnzhau ~/PenTestTools
